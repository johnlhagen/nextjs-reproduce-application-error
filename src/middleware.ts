...
export const middleware: NextMiddleware = (request: NextRequest) => {
  // const geoData = getCountryAndRegionFromRequest(request);
  // const response = handleRedirectOrRewriteIfRequired(request, geoData) ?? NextResponse.next();
  // return setCookiesOnResponse(NextResponse.next(), request, geoData);
